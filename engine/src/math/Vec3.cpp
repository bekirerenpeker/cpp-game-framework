...
// static functions
float Vec3::sqrDist(const Vec3& a, const Vec3& b) { return (a - b).sqrMagnitude(); }
float Vec3::dist(const Vec3& a, const Vec3& b) { return (a - b).magnitude(); }
Vec3 Vec3::dir(const Vec3& from, const Vec3& to) { return (to - from).normalized(); }
